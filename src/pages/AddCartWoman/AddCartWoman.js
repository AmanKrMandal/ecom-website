...
import "./AddCartWoman.css";
import womanShirt from "../../assests/Image/womanShirt.jpg";
      ...
      <main className="mainCart">
        <section className="miniCart">
          ...
          <div className="textCart">
            ...
            <Link to="/checkout" className="add" style={{textDecoration:"none"}}>
              ADD TO CART
            </Link>
